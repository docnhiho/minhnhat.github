...
@Controller
@RequestMapping(value = "cartus")
public class CartusController {
	...
	// B1-Mua SP
			@RequestMapping(value = "/orderus/{id}", method = RequestMethod.GET)
			public String ordernow(ModelMap mm, HttpSession session, @PathVariable("id") int id) {
				...
				return "cart-us/cartusitem-user";
			}
			
		    // Delete SP
			@RequestMapping(value = "/deleteus/{id}", method = RequestMethod.GET)
			...
			//Update SL
			@RequestMapping(value = "/updateus", method = RequestMethod.POST)
...
//			    	session.removeAttribute("cart");
					return "cart-us/cartus-user";
			}

			// B3-Save hoa don
			@RequestMapping(value = "/saveOrder-us", method = RequestMethod.POST)
			...
			@RequestMapping(value = "/cartus", method = RequestMethod.GET)
