								...
								<div class="shopping-cart ml-30">
									...
									<ul>
										...
										<li>
											...
											<div class="shipping">
												<span class="f-left"> Tổng Tiền </span> <span
													class="f-right cart-price"><fmt:formatNumber
														value="${s}" /> VND</span>
											</div>
										</li>
										<li class="checkout m-0"><a
											href="${pageContext.request.contextPath }/shoppingcart/receipt">Đặt Hàng
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<form method="post"
							action="${pageContext.request.contextPath }/shoppingcart/update">
							<div class="table-content table-responsive">
								<table>
									<thead>
										<tr>
											<th class="product-name">XÓA SẢN PHẨM</th>
										...
										<tbody>
											<tr>
												...
												<td class="product-remove"><a
													href="${pageContext.request.contextPath }/shoppingcart/delete/${it.sanpham.id }"><i
														class="fa fa-times"></i></a></td>
												<td class="product-thumbnail"><a href="#"><img
														src="<%=request.getContextPath()%>/resources/images/${it.sanpham.image}"
														class="img-responsive" alt=""></a></td>
												<td class="product-name"><a href=""><c:out
															value="${it.sanpham.tensanpham}" /></a></td>
												<td class="product-price"><span class="amount">
														<fmt:formatNumber value="${it.sanpham.gia}" />
												</span> VND</td>
												<td class="product-quantity"><input name="quantity"
													value="${it.quantity}" type="number" required="required"
													pattern="[0-9]{1,12}" /></td>
												<td class="product-subtotal"><span class="actual">
														<fmt:formatNumber value="${it.quantity * it.sanpham.gia}" />
												</span>VND</td>
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="coupon-all">
										<div class="coupon2">
											<input class="button" name="quantity" value="Cập nhật số lượng"
								...
								<div class="cart-total">
									<a href="<c:url value="/index"/>">Tiếp tục mua hàng</a>
								</div>
							</div>
							<div class="row">
								<div class="col-md-5 col-md-offset-7 col-sm-12 col-xs-12">
									<div class="cart-total">
										<h2>Cart totals</h2>
										<ul>
											<li>Tổng Tiền<span> <fmt:formatNumber value="${s1}" />
													VND
											</span></li>
										</ul>
										<a
											href="${pageContext.request.contextPath }/shoppingcart/receipt">Đặt Hàng</a>
									</div>
								</div>
							</div>
						</form>
