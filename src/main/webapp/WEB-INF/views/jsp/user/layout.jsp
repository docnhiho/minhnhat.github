	...
	<footer>
		<div id="footer-bottom-wrap">
			<section id="footer-bottom">
				<p><a href="index.htm">WEBSITE BÁN ĐIỆN THOẠI VÀ LAPTOP</a></p>
				<!-- SOCIAL LINKS -->
...
<script type="text/javascript">
	function update(qty, productId) {
		var quantity = parseInt(qty.trim());
		
		// Kiểm tra đường dẫn để hiển thị đúng cho người dùng
		var path = window.location.pathname;
		var link;
			// Nếu là trang chi tiết sản phẩm, gán link = 1
			// Nếu là trang giỏ hàng, gán link = 2
			// Nếu là trang thanh toán, gán link = 3
			// Nếu là trang phân loại, gán link = 4
			// Nếu là trang chủ, gán link = 0
		if(path.startsWith("/DuAn/product.htm")) {
			link = 1;
		}else if(path.startsWith("/DuAn/cart")) {
			link = 2;
		}else if(path.startsWith("/DuAn/checkout")) {
			link = 3;
		}else if(path.startsWith("/DuAn/productCate")) {
			link = 4;
		}else {
			link = 0;
		}
		...
		window.location =  "<c:url value="/cart/update.htm"/>" + "?id=" + productId + "&qty=" + quantity + "&link=" + link;
	
		
		
		function checkInput() {
			// Kiểm tra nhập thanh toán
			...
			if(nameValue === '') {
				setErrorFor(name, 'Không được để trống tên.');
				result = false;
			}			
			...
			if(phoneValue === '') {
				...
				setErrorFor(phone, 'Không đúng định dạng email.')
				result = false;
			}
			
			if(addressValue === '') {
				setErrorFor(address, 'Không được để trống tên.');
				result = false;
			}			
...
<!-- jQuery -->
<script src="resources/user/js/vendor/jquery-1.11.1.min.js"></script>
<!-- XM Accordion -->
<script src="resources/user/js/vendor/jquery.xmaccordion.min.js"></script>
<!-- Owl Carrousel -->
<script src="resources/user/js/vendor/owl.carousel.min.js"></script>
<!-- XM Tab -->
<script src="resources/user/js/vendor/jquery.xmtab.min.js"></script>
<!-- Magnific Popup -->
<script src="resources/user/js/vendor/jquery.magnific-popup.min.js"></script>
<!-- imgLiquid -->
<script src="resources/user/js/vendor/imgLiquid-min.js"></script>
<!-- JRange -->
<script src="resources/user/js/vendor/jquery.range.min.js"></script>
<!-- Header -->
<script src="resources/user/js/header.js"></script>
<!-- Menu -->
<script src="resources/user/js/menu.js"></script>
<!-- Home -->
<script src="resources/user/js/home.js"></script>
<!-- Shop -->
<script src="resources/user/js/shop.js"></script>
<!-- Full View -->
<script src="resources/user/js/full-view.js"></script>
<!-- Product Builder -->
<script src="resources/user/js/product-builder.js"></script>
</body>
</html>