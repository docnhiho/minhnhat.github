					...
					<div class="container-fluid">
						...
						<div class="card shadow mb-5">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Update Loại
									Sản Phẩm</h6>
							</div>

							<c:url value="/updateLoaisp" var="updateLoaisp" />
							<form:form id="loaispUpdate" action="${updateLoaisp}"
								method="POST" modelAttribute="loaisp">
								<div class="form-row" style="padding: 20px">
									<div class="form-group col-md-6">
										<label>ID</label>
										<form:input class="form-control" path="id" readonly="true" />
										<br /> <br /> <label>Loại Sản Phẩm</label>
										<form:input class="form-control" path="tenloaisp"
											placeholder="Nhập loại sản phẩm" required="required"
											pattern="[a-zA-Z]\{25}" title="Loại sản phẩm" />
										<br /> <br />
										<form:button type="submit" class="btn btn-success">
											<i class="far fa-save"></i> Update</form:button>
										<form:button id="editbutton" type="submit"
											class="btn btn-danger">
											<a href="<c:url value="/loaisanpham-list" />"><i
