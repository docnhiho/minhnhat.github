			...
			<div class="container-fluid">
				...
				<div class="card shadow mb-5">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Thêm Mới Khách
							Hàng</h6>
					</div>

					<form:form id="KhachhangSave" action="${saveKhachhang}"
						...
						<div class="form-row" style="padding: 20px">
							<div class="form-group col-md-6">
								...
								<form:input class="form-control" path="sdt"
									placeholder="Type Here" required="required"
									pattern="[0-9]{10,11}" title="Please type Phone Number" />
							</div>
							<br />
							<div class="form-group col-md-6">
								<label>Address:</label>
								<form:input class="form-control" path="diachi"
									placeholder="Type Here" required="required"
									pattern="[a-z]\{100}" title="Please Address" />
								<br />
