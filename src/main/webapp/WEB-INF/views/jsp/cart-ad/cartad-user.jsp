	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="<c:url value="/doanhthu-list"/>"> <i
					class="fas fa-fw fa-tachometer-alt"></i> <span>Doanh Thu</span></a></li>
				...
				<div id="collapseTwo6" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<c:url value="/recyclebin"/>">Hóa
							Đơn</a> <a class="collapse-item" href="<c:url value="/sanpham-bin"/>">Sản
							Phẩm</a>
					...
					<div class="container-fluid">
						<section class="section contact-section" id="next">
							...
							<div class="card shadow mb-5">
								...
								<%-- 									action="${pageContext.request.contextPath}/cartad/saveOrder"> --%>
								<!-- 									<div class="form-row" style="padding: 20px"> -->
								<!-- 										<div class="form-group col-md-6" > -->
								<%-- 											<label> Tên Khách Hàng</label> <form:input --%>
								<%-- 												class="form-control" path="receiptName" --%>
								<%-- 												placeholder="Type Here" required="required" pattern="[A-Za-z]\{50}" --%>
								<%-- 												title="Please type here" /> <br />  --%>
								<!-- 												<label> Email</label> -->
								<%-- 											<form:input class="form-control" path="receiptMail" --%>
								<%-- 												placeholder="Type Here" required="required" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" --%>
								<%-- 												title="Please type here" /> --%>
								<!-- 											<br /> <label> Địa Chỉ</label> -->
								<%-- 											<form:input class="form-control" path="receiptAddress" --%>
								<%-- 												placeholder="Type Here" required="required" pattern="[a-z0-9]\{100}" --%>
								<%-- 												title="Please type here" /> --%>
								<!-- 											<br /> <label> Số Điện Thoại</label> -->
								<%-- 											<form:input class="form-control" path="receiptPhone" --%>
								<%-- 												placeholder="Type Here" required="required" pattern="[0-9]{10}" --%>
								<%-- 												title="Please type here" /> --%>
								<!-- 											<br /> -->
								<!-- 											<div class="col-md-12"> -->
								...
								<%-- 													<a href="<c:url value="/sanpham-list"/>" style="color: #fff">Return</a> --%>
								<%-- 												</form:button> --%>
								<!-- 											</div> -->
								<!-- 										</div> -->
								<!-- 									</div> -->
								...
								<form:form method="POST"
									action="${pageContext.request.contextPath}/cart/saveOrder-ad">
									<div class="form-row" style="padding: 20px">
										<div class="form-group col-md-6">
                                        <input class="fm-ctrl form-control-lg" type="hidden" name="employeeid"
												value="${id}" />
											<br /> <label> Tên Khách Hàng</label> <input
											...
											<button id="editbutton" type="submit" class="btn btn-danger">
												<a href="${pageContext.request.contextPath }/cart/cartad"><i
