				...
				<div id="content-wrapper">
					<div class="container-fluid">
						...
						<div class="card shadow mb-5">
							...
							<c:url value="/updatePhieunhap" var="updatePhieunhap" />
							<form:form action="${updatePhieunhap}" method="POST"
								modelAttribute="phieunhap">
								<div class="form-row" style="padding: 20px">
									<div class="form-group col-md-6">
										<label>ID</label>
										<form:input class="form-control" path="id" readonly="true" />
										<br /> <label>Nhà Cung Cấp</label> <select
											class="form-control" name="manhacungcap">
										...
										<form:input class="form-control" path="loaisanpham"
											placeholder="Type Here" required="required"
											pattern="[a-z]\{20}" title="Please type Full Name" />
										<br />
										...
										<form:button id="editbutton" type="submit"
											...
											<a href="<c:url value="/phieunhap-list" />"><i
