					...
					<div class="container-fluid">
                       <div class="card shadow mb-5">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Thêm Mới Nhân Viên
									</h6>
							</div>
							...
							<div class="form-row" style="padding: 20px">
								<div class="form-group col-md-6">
									...
									<form:input class="form-control" path="birthday"
										id="datepicker" placeholder="Birthday" required="required"
									...
									<br /> <label>CMND:</label>
									<form:input class="form-control" path="govermentid"
									...
									<form:input class="form-control" path="phone"
										placeholder="Phone" required="required" pattern="[0-9]{10}"
								...
								<div class="form-group col-md-6">						
									...
									<label>Image:</label>
									<output id="list">
										<img src="/MushtaqShop/resources/images/employee/" width="120"
											heigh="100"
