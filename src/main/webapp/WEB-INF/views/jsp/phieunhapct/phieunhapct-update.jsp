					...
					<div class="container-fluid">
						...
						<div class="card shadow mb-5">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Update Phiếu
									Nhập Chi Tiết</h6>
							</div>

							<c:url value="/updatePhieunhapct" var="updatePhieunhapct" />
							<form:form action="${updatePhieunhapct}" method="POST"
								modelAttribute="phieunhapct">
								<div class="form-row" style="padding: 20px">
									<div class="form-group col-md-6">
										<label>ID:</label>
										<form:input class="form-control" path="id" readonly="true" />
										<br /> <label>Mã Phiếu Nhập</label>
										<form:input type="text" class="form-control"
											path="maphieunhap" readonly="true" />
										<br /> <label>Loại Sản Phẩm</label>
										<form:input type="text" class="form-control"
											path="loaisanpham" readonly="true" />
									...
									<div class="form-group col-md-6">
									 ...
									 <form:input  class="form-control" path="gia"
										...
										<form:input class="form-control" path="tongtien"
											readonly="true" />
										<br /> <br />
										<form:button style="margin-bottom: 10px" type="submit"
